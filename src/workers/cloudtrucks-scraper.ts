...
const getExecutablePath = async () => {
    ...
    // Local development - try common locations
    const commonPaths = [
...
/**
 * Scrape loads based on criteria (Old logic ported to Puppeteer)
 * Note: Leaving this as placeholder implementation as focusing on Booked Loads first
 */
export async function scrapeCloudTrucksLoads(
    ...
    console.log('Search scraping temporarily disabled during migration. Focus on Sync Booked Loads.');
    return [];
}
...
export async function scrapeBookedLoads(
    ...
    try {
        ...
        await page.goto('https://app.cloudtrucks.com/jobs/', { waitUntil: 'networkidle2' });
